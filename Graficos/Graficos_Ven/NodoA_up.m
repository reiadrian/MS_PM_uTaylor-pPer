...
pos = 1:51;
pos2 = [1:11 13:20 22:29 32:38 41:47 49:51];
%*******************************************************************************
%* TENSIONES                                                             *
%*******************************************************************************
%*******************************************************************************
...
main_example_path =['/home/reiadrian/workspace/LAGRANGE2/Ejemplos/RVE_01/'];
...
h= gobjects(10,1); 
% subplot(2,1,1)
h(1,1)=semilogx(xy(pos2,1),xy(pos2,2),'r--o','LineWidth',2,'MarkerSize',8);
...
% xy = str2double(xy(:,:));
% % Grafico 1
% h(3,1)=semilogx(xy(pos2,1),xy(pos2,2),'b--s','LineWidth',2,'MarkerSize',8);
...
% % PARA MODIFIFICAR EL ARCHIVO DE INGRESO SOLO HACE FALTA CAMBIAR EL
% % DIRECTORIO EN LA LINEA INFERIOR
% main_example_path =['/home/reiadrian/workspace/LAGRANGE/Ejemplos/RVE_01/'];
% path_file= main_example_path; file = 'Macro008.dat' ; %'\Examples\MS_Comp\'
% file_open = fullfile(path_file,file);
% fid = fopen(file_open,'r');
% 
% % Numero de graficos provenientes del codigo
...
% % PARA MODIFIFICAR EL ARCHIVO DE INGRESO SOLO HACE FALTA CAMBIAR EL
% % DIRECTORIO EN LA LINEA INFERIOR
% main_example_path =['/home/reiadrian/workspace/LAGRANGE2/Ejemplos/RVE_05/'];
% path_file= main_example_path; file = 'Macro008.dat' ; %'\Examples\MS_Comp\'
% file_open = fullfile(path_file,file);
% fid = fopen(file_open,'r');
% 
...
% %* SE CIERRA ARCHIVO                                                           *
% %*******************************************************************************
% lgd1 = legend({'RVE (0.1x0.1)-RCE','RVE (0.5x0.5)-RCE',...
%     'RVE (1X1)-RCE','RVE (0.1x0.1)-OCE','RVE (0.5x0.5)-OCE','RVE (1X1)-OCE'},...
% 'Location','northeast');
% lgd1.FontSize = 24;
% fclose(fid);
% 
