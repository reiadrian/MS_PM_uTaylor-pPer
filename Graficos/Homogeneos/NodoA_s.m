...
path_file= main_example_path; file = 'Macro022.dat' ; %'\Examples\MS_Comp\'
...
xy = str2double(xy(:,:));
% Grafico 1
h(8,1)=semilogx(xy(1:nSteps,1),xy(1:nSteps,2),'b--d','LineWidth',2,'MarkerSize',8);
set(gca,'XAxisLocation','top');
grid on
ylabel('Effective stress - \sigma_{22} [kPa]','FontSize',24,'FontWeight','bold','Color','k');
xlabel('Time [day] ','FontSize',24,'FontWeight','bold','Color','k');
...
xy = str2double(xy(:,:));
% Grafico 1
h(8,1)=semilogx(xy(1:nSteps,1),xy(1:nSteps,2),'r--*','LineWidth',2,'MarkerSize',8);
set(gca,'XAxisLocation','top');
grid on
ylabel('Effective stress - \sigma_{22} [kPa]','FontSize',24,'FontWeight','bold','Color','k');
xlabel('Time [day] ','FontSize',24,'FontWeight','bold','Color','k');
