...
if e_VG.conshyp==17
    ...
    Fext(1:e_VG.ndoft-3,3) = Fext(1:e_VG.ndoft-3,3) + sparse([c_FilFzazz{:}],1,cat(1,c_Fextzz{:}));
    Fext(1:e_VG.ndoft-3,4) = Fext(1:e_VG.ndoft-3,4) + sparse([c_FilFzaxy{:}],1,cat(1,c_Fextxy{:}));
else
    % Ensamble de matriz de fuerzas externas global
