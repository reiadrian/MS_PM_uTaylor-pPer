...
function [KT,Fint,u,c_GdlCond,e_VarEst_new,e_VarAux,c_sig_eps,o_Par] = ...
    f_Par_MatGlobales_analyticPM(xx,u,u_old,c_GdlCond,e_DatSet,e_VarEst_new,...
...
%     for iElem = 1:nElem
        ...
        [m_Ke(:,:,iElem),m_Fint(:,iElem),u(:,iElem),eps_new(:,iElem),phi_new(:,iElem),...
            ...
            f_MatElem_BifaseMulTSc_analytic(uElemSet(:,iElem),u_oldElemSet(:,iElem),...
...
% Ensamble del vector de incognitas global
u = sparse([c_FilFza{:}],1,cat(1,c_u{:}));
