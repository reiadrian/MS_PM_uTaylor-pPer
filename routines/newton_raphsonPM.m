function [u,c_GdlCond,Fint2,e_VarEst_new,e_VarAux,Du_step_new,c_CT,KT,lambda,o_Par] = newton_raphsonPM(xx,m_LinCond,dofl,doff,u,Du_step_new,...
...
[KT,Fint,c_GdlCond,e_VarEst_new,e_VarAux] = f_Par_MatGlobalesPM(xx,u,u_old,c_GdlCond,e_DatSet,...
...
while (norm_res>tol_rel||norm_desp>tol_rel||norm_por>tol_rel)&&iter<max_iter||iter<1
   ...
   [KT,Fint,c_GdlCond,e_VarEst_new,e_VarAux,c_CT,o_Par] =...
        f_Par_MatGlobalesPM(xx,u,u_old,c_GdlCond,e_DatSet,e_VarEst_new,e_VarEst_old,...
